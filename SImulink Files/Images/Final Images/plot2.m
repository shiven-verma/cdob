...
plot(t1, y1, 'r', 'LineWidth', 2.5); % 'r-' specifies a red solid line
hold on;
plot(t2, y2, 'b', 'LineWidth', 2.5);
hold on;
plot(t3, y3, 'y', 'LineWidth', 2.5);
hold on;
plot(t4, y4, 'g', 'LineWidth', 2.5);
hold on;
plot(t5, y5, 'm', 'LineWidth', 2.5);
hold on;
plot(t6, y6, 'c', 'LineWidth', 2.5);
